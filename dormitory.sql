...
CREATE TABLE `dorm_check`  (
  ...
  `grade` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '及格或者不及格',
  ...
  `operatorName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '操作人',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `dorm_check` VALUES (1, 1003, '及格', '123412', '2023-03-18 18:06:49', 'admin');
INSERT INTO `dorm_check` VALUES (2, 1004, '不及格', ' 有违纪物', '2023-03-18 19:00:46', 'admin');
INSERT INTO `dorm_check` VALUES (3, 1004, '及格', '1243423', '2023-03-18 19:15:55', 'admin');
INSERT INTO `dorm_check` VALUES (4, 1103, '不及格', '卫生太差', '2023-03-18 19:17:23', 'admin');
INSERT INTO `dorm_check` VALUES (5, 1003, '及格', '1003', '2023-03-18 22:06:11', 'admin');
INSERT INTO `dorm_check` VALUES (6, 111111, '及格', '1', '2023-03-28 13:26:12', 'test');
INSERT INTO `dorm_check` VALUES (7, 1103, '及格', 'sss', '2023-05-15 15:58:00', 'admin');

-- ----------------------------
-- Table structure for dorm_electric
-- ----------------------------
DROP TABLE IF EXISTS `dorm_electric`;
CREATE TABLE `dorm_electric`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `operatorName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '操作人姓名',
  `roomid` int NOT NULL COMMENT '宿舍号',
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '类型: 充值/扣费',
  `money` double NULL DEFAULT NULL COMMENT '金额',
  `date` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '日期',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1627402260 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of dorm_electric
-- ----------------------------
INSERT INTO `dorm_electric` VALUES (-1887424511, 'stu10', 1103, '充值', 100, '2023-03-17 22:02:13');
INSERT INTO `dorm_electric` VALUES (247517186, 'stu10', 1103, '充值', 1, '2023-03-17 21:53:06');
INSERT INTO `dorm_electric` VALUES (566243330, 'stu10', 1103, '充值', 0, '2023-03-17 22:02:27');
INSERT INTO `dorm_electric` VALUES (1627402241, 'stu10', 1103, '充值', 120, '2023-03-17 22:02:20');
INSERT INTO `dorm_electric` VALUES (1627402242, 'stu10', 1103, '充值', 12, '2023-03-17 23:06:40');
INSERT INTO `dorm_electric` VALUES (1627402243, 'stu10', 1103, '充值', 123, '2023-03-17 23:06:43');
INSERT INTO `dorm_electric` VALUES (1627402244, 'admin', 1103, '扣费', 100, '2023-03-17 23:12:10');
INSERT INTO `dorm_electric` VALUES (1627402245, 'admin', 1102, '扣费', 1, '2023-03-17 23:18:59');
INSERT INTO `dorm_electric` VALUES (1627402246, 'stu10', 1103, '充值', 12, '2023-03-18 00:20:14');
INSERT INTO `dorm_electric` VALUES (1627402247, 'admin', 2102, '扣费', 1.1, '2023-03-18 15:20:34');
INSERT INTO `dorm_electric` VALUES (1627402248, 'stu10', 1103, '充值', 1.1, '2023-03-18 15:21:39');
INSERT INTO `dorm_electric` VALUES (1627402249, 'admin', 1103, '扣费', 0.5, '2023-03-18 15:33:38');
INSERT INTO `dorm_electric` VALUES (1627402250, 'admin', 1103, '扣费', 1, '2023-03-18 15:33:52');
INSERT INTO `dorm_electric` VALUES (1627402251, 'admin', 1103, '扣费', 10, '2023-03-18 15:34:18');
INSERT INTO `dorm_electric` VALUES (1627402252, 'admin', 1103, '扣费', 0.5, '2023-03-18 15:43:49');
INSERT INTO `dorm_electric` VALUES (1627402253, 'admin', 1103, '扣费', 5, '2023-03-18 16:52:42');
INSERT INTO `dorm_electric` VALUES (1627402254, 'admin', 6103, '扣费', 0.5, '2023-03-18 16:56:37');
INSERT INTO `dorm_electric` VALUES (1627402255, 'stu10', 1103, '充值', 100, '2023-03-18 22:07:14');
INSERT INTO `dorm_electric` VALUES (1627402256, 'admin', 1103, '扣费', 60, '2023-03-18 23:03:37');
INSERT INTO `dorm_electric` VALUES (1627402257, 'admin', 2102, '扣费', 60, '2023-03-18 23:04:19');
INSERT INTO `dorm_electric` VALUES (1627402258, 'admin', 2102, '扣费', 50, '2023-03-18 23:04:54');
INSERT INTO `dorm_electric` VALUES (1627402259, 'admin', 1103, '扣费', 12, '2023-05-15 15:03:07');
...
-- ----------------------------
-- Table structure for dorm_water
-- ----------------------------
...
CREATE TABLE `dorm_water`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2126553091 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of dorm_water
-- ----------------------------
INSERT INTO `dorm_water` VALUES (-1814204414, 'admin', 1103, '扣费', 12, '2023-05-15 13:58:23');
INSERT INTO `dorm_water` VALUES (-951980030, 'stu10', 1103, '充值', 1, '2023-03-18 23:13:27');
INSERT INTO `dorm_water` VALUES (-863899647, 'admin', 1103, '扣费', 7.5, '2023-03-18 23:35:19');
INSERT INTO `dorm_water` VALUES (-713015294, 'stu10', 1103, '充值', 112, '2023-03-18 00:32:06');
INSERT INTO `dorm_water` VALUES (-633270270, 'admin', 1103, '扣费', 5, '2023-03-18 16:54:56');
INSERT INTO `dorm_water` VALUES (-490606590, 'stu10', 1103, '充值', 100, '2023-03-18 23:13:10');
INSERT INTO `dorm_water` VALUES (-293474303, 'stu10', 1103, '充值', 100, '2023-03-19 00:37:51');
INSERT INTO `dorm_water` VALUES (209731586, 'stu10', 1103, '充值', 12, '2023-03-18 00:32:02');
INSERT INTO `dorm_water` VALUES (408776706, 'stu1', 1102, '充值', 12, '2023-05-15 14:19:47');
INSERT INTO `dorm_water` VALUES (767684610, 'admin', 1103, '扣费', 2.5, '2023-03-18 15:35:35');
INSERT INTO `dorm_water` VALUES (889262082, 'admin', 1103, '扣费', 5, '2023-03-18 16:53:18');
INSERT INTO `dorm_water` VALUES (1229000705, 'admin', 21003, '扣费', 5, '2023-03-18 16:55:57');
INSERT INTO `dorm_water` VALUES (1973252098, 'admin', 1103, '扣费', 122, '2023-05-15 13:54:57');
INSERT INTO `dorm_water` VALUES (2084638721, 'stu10', 1103, '充值', 0.5, '2023-03-18 16:41:30');
INSERT INTO `dorm_water` VALUES (2126553090, 'admin', 21003, '扣费', 25, '2023-03-18 16:27:58');
...
CREATE TABLE `health`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `username` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '姓名(学号)',
  `pressure` int NOT NULL COMMENT '血压',
  `glucose` int NOT NULL COMMENT '血糖',
  `oxygen` int NOT NULL COMMENT '血氧',
  `heart` int NOT NULL COMMENT '心跳次数',
  `breathe` int NOT NULL COMMENT '呼吸次数',
...
-- Records of health
-- ----------------------------
INSERT INTO `health` VALUES (1, 'test', 120, 5, 99, 60, 75, '2023-03-12');
INSERT INTO `health` VALUES (2, 'test', 130, 4, 88, 44, 55, '2023-03-11');
INSERT INTO `health` VALUES (4, 'test', 123, 2, 89, 44, 53, '2023-03-13');
INSERT INTO `health` VALUES (5, 'test', 123, 4, 44, 21, 12, '2023-03-10');
INSERT INTO `health` VALUES (6, 'test', 123, 2, 55, 32, 13, '2023-03-09');
INSERT INTO `health` VALUES (7, 'test', 123, 12, 90, 34, 12, '2023-03-08');
INSERT INTO `health` VALUES (8, 'stu1', 123, 2, 99, 55, 66, '2023-03-13');
INSERT INTO `health` VALUES (9, 'test', 123, 4, 88, 66, 54, '2023-03-07');
INSERT INTO `health` VALUES (10, 'test', 140, 6, 98, 56, 34, '2023-03-06');
INSERT INTO `health` VALUES (11, 'test', 123, 3, 66, 66, 44, '2023-03-05');
INSERT INTO `health` VALUES (12, 'test', 133, 4, 100, 67, 44, '2023-03-04');
INSERT INTO `health` VALUES (13, 'test', 143, 5, 99, 55, 32, '2023-03-03');
INSERT INTO `health` VALUES (14, 'test', 132, 4, 90, 89, 54, '2023-03-02');
INSERT INTO `health` VALUES (15, 'test', 156, 4, 98, 44, 33, '2023-03-14');
INSERT INTO `health` VALUES (16, 'test', 143, 2, 88, 34, 23, '2023-03-01');
INSERT INTO `health` VALUES (17, 'test', 134, 3, 99, 44, 23, '2023-02-28');
INSERT INTO `health` VALUES (18, 'admin', 120, 3, 99, 55, 55, '2023-03-24');
INSERT INTO `health` VALUES (19, 'stu11', 120, 2, 99, 66, 66, '2023-03-30');
INSERT INTO `health` VALUES (20, 'stu11', 111, 1, 99, 44, 44, '2023-03-29');
