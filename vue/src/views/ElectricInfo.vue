        ...
        <div>
          ...
          >
            ...
            >
              ...
              <el-form-item label="宿舍号" v-if="role != 'stu' || disabled" prop="roomid">
                <el-input
                  v-model="form.roomid"
                  :disabled="disabled"
                  clearable
            ...
            <span v-if="!disabled" style="color:red">**注意：请按照线下缴费，线上办理的方式进行</span>
            <template #footer>
...
<script src="@/assets/js/ElectricInfo.js"></script>